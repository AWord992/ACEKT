...
def init_model(model_name, model_config, data_config, emb_type):
    ...
    elif model_name == "acekt":
        model = aceKT(data_config["num_c"], data_config["num_q"], **model_config, emb_type=emb_type, emb_path=data_config["emb_path"]).to(device)
